    ...
    <link href="{{asset('css/frontend/descnivel.css')}}" rel="stylesheet">
    <link href="{{asset('css/frontend/perguntas.css')}}" rel="stylesheet">
    <link href="{{asset('css/frontend/pontosfortesfracos.css')}}" rel="stylesheet">
